...
namespace AdventOfCode2020.Tests
{
	...
	{
		private string _passports = @"iyr:2015 cid:189 ecl:oth byr:1947 hcl:#6c4ab1 eyr:2026
hgt:174cm
pid:526744288
...
pid:453480077 eyr:2025 hcl:#a97842";
		...
		public void Task1()
		{
			var input = _passports.Split(Environment.NewLine + Environment.NewLine);

			var output = new Day4().Task1(input);

			Assert.Pass(output.ToString()); // Answer: 264.
		}
		...
		public void Task2()
		{
			...
			var output = new Day4().Task2(input);

			Assert.Pass(output.ToString()); // Answer: 226.
		}
	}
}
